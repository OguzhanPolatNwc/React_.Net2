...
namespace API
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            //This will look index.html inside wwwroot folder ( Below 2 are for production)
            app.UseDefaultFiles();
            app.UseStaticFiles();
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                //This is a controller that we need to create for the purpose of returning the index when our API encounters rates that it 
                //API products, not API ordersdoesn't understand, as in anything that's not ( Fallback )
